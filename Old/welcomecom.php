...
$result=mysql_query("select * from tblcomreg where email='$email' ")
or die(mysql_error());
$row=mysql_fetch_array($result);
}
else
{
header('location:companylogin.php3');
}
?>
...
<form method="POST" action="updatecom.php3">
<table style="height:92%;width:100%">
<tr>
<td style="width:20%;background-color:C8CABD">
<font size="5"><center>
<a href="viewjobseeker.php3" style="text-decoration:none">View Jobseeker Detail</a></br></br>
<a href="logoutcom.php3" style="text-decoration:none">LogOut</a></br></br>
</center></font>
</td>
<td>
<table align="center">
